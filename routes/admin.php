...
Route::group(['prefix' => 'terms'],function(){
    Route::get('/', [TermsController::class,"index"])->name('terms')->can('view-advertisement');
    Route::get('/upsert/{terms?}',[TermsController::class,'upsert'])->name('terms.upsert')->can('upsert-advertisement');
    Route::get('/filter',[TermsController::class,'filter'])->name('terms.filter')->can('upsert-advertisement');
    Route::post('/modify',[TermsController::class,'modify'])->name('terms.modify')->can('view-advertisement');
    Route::post('/delete/{terms}',[TermsController::class,'destroy'])->name('terms.delete')->can('delete-advertisement');
});
...
Route::group(['prefix' => 'portofolio1'],function(){
    Route::get('/', [Portfolio_experience1Controller::class, 'create'])->name('crate_port_exp1');
